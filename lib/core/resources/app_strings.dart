abstract class AppStrings {
  //AppBar
  static const String appBarMainName = 'Notes Test';
  ...
  static const String questionCloseFloatingNote =
      'Are you sure that you want to close the note?';

  //Alert dialog
  static const String titleQuestionDelete = 'Delete note?';
  static const String questionDelete =
      'Are you sure you want to delete this note?';
  static const String answerYes = 'Yes';
  static const String answerNo = 'No';

  //Edit Note
  static const String questionCloseEditNote =
      'Are you sure that you want to close the edit note?';

  //SnackBar
  static const String fieldCannotBeEmpty = 'Fields cannot be empty';
  static const String fillTitleField = 'Fill in the title field';
  static const String fillTextField = 'Fill in the text field';

  //States
  static const String stringListScreenIsEmpty = 'Notes Screen Is Empty';
