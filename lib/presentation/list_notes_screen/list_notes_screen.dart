              ...
              return InkWell(
                child: Padding(
                  ...
                  child: GestureDetector(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: SizedBox(
                              ...
                              child: Column(
                                children: [
                                  Text(noteList[index].noteDescription),
                                  Visibility(
                                      visible: noteList[index].category != null
                                          ? true
                                          : false,
                                      child:
                                          Text(noteList[index].category ?? ''))
                                ],
                              ),
                            ),
                          );
                    ...
                    //Card
                    child: Card(
                      color: noteList[index].isFinished
                          ? Colors.grey
                          : Colors.white,
                      child: Row(
                        children: [
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return EditNoteDialog(
                                      ...
                                      category: state.noteList[index].category,
                                      isFinished:
                                          state.noteList[index].isFinished,
                                      initialTitle:
                                          state.noteList[index].noteName,
                                      initialDescription:
                                          state.noteList[index].noteDescription,
