...
import 'package:flutter_notes_and_api_test/presentation/list_notes_screen/widgets/category_dropdown_widget.dart';
...
import '../notes_bloc/list_screen_bloc.dart';
            ...
            Row(
              ...
              children: [
                ...
                FilledButton(
                    ...
                    child: Text(isFinished ? 'Finished' : 'Unfinished')),
              ],
            ),
            const SizedBox(height: AppSizes.k8),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
...
class FilterNoteDialog extends StatefulWidget {
  final ListScreenBloc bloc;
  final VoidCallback onEdit;

  const FilterNoteDialog({
    Key? key,
    required this.bloc,
    required this.onEdit,
  }) : super(key: key);
  ...
  @override
  State<FilterNoteDialog> createState() => _FilterNoteDialogState();
}

class _FilterNoteDialogState extends State<FilterNoteDialog> {
  String? currentCategoryFilter = '';
  bool isFinishedFilter = false;
            ...
            Row(
              ...
              children: [
                ...
                FilledButton(
                    ...
                    child: Text(isFinishedFilter ? 'Finished' : 'Unfinished')),
              ],
            ),
            const SizedBox(height: AppSizes.k8),
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    print(currentCategoryFilter);
                    print('$isFinishedFilter');
                    widget.bloc.add(FilterByEvent(
